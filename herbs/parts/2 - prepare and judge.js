...
prepare
	...
	eine zur rechten und eine zur linken müsst ihr mit euren geflügelten hühnerärmchen an meinen beinen fest halten
...
gods judgement
	...
	missbrauch von umwelt, und allem
		himmel: sieht man sich als teil des ganzen und kümmert sich wie um einen selbst
		hölle: alles was nicht man selbst ist und sich nicht wehrt, kann zum eigenen vorteil missbraucht werden
		alle: was ihr eurem nächsten antut, wozu alles gehört was nicht ihr selbst seid, das tut ihr über kurz oder lang dennoch euch selbst an
	
	so, das wars schon fast bis auf eines
		dazu steht bitte auf, dreht euch um und schaut von mir weg
		seht ihr alle die an diesen großartigsten ort aller zeiten gekommen sind?
		seht ihr sie? ich höre euch nicht, seht ihr sie?
		ich höre euch noch immer nicht, seht ihr sie???
		seht, all die menschen die ihr vor euch seht um so nah wie möglich an den großartigsten ort zu kommen
		all die menschen habt ihr von euch weg gestoßen!
		(gehe selbst auf die knie, den stab vor mir liegend)
		aber dreht euch bitte um und seht,
		ich bin der schlimmste von allen von euch
		und ich haben es am meisten nötig mich zu demütigen
		
		denn seht, im himmel ist die demut das größte
		und alles großartige das geringste
		
		(halte inne für ein paar sekunden)
